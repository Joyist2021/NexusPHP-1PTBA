...
--
-- Host: localhost
-- Generation Time: 2021-02-04 03:07:40
-- 服务器版本： 5.5.62-log
-- PHP Version: 5.6.40
...
) ENGINE=MyISAM AUTO_INCREMENT=38997 DEFAULT CHARSET=utf8;
...
(10, '规则管理', 'modrules.php', '编辑/添加/删除规则页'),
(8, '种子促销设置', 'freeleech.php', '设置所有任务，在特殊的国家'),
(9, 'FAQ管理', 'faqmanage.php', '编辑/添加/删除FAQ页'),
(7, '警告用户', 'warned.php', '查看所有警告用户跟踪'),
(6, '投票概述', 'polloverview.php', '查看投票方式进行表决'),
(4, '群发消息', 'staffmess.php', '发短消息给所有用户'),
(3, '重设用户密码', 'reset.php', '修改丢失的密码'),
(1, '添加用户', 'adduser.php', '创建新用户帐户'),
(11, '上传分类管理', 'catmanage.php', '在您的网站，管理分类类别');
...
(12, 'qBittorrent v3.x', 'qBittorrent v3.3', '/-qB3([0-9A-F])([0-9A-F])([0-9A-F])-/', 3, 'hex', '-qB3300-', '/^qBittorrent v3.([0-9]+).([0-9]+)/', 2, 'dec', 'qBittorrent v3.3.0', 'no', 'yes', '', 1),
(13, 'qBittorrent4.x.x', 'qBittorrent4.x.x', '/-qB4([0-9A-F])([0-9A-F])([0-9A-F])-/', 3, 'hex', '-qB4010-', '/^qBittorrent\\/4\\.([0-9]+)\\.([0-9]+)/', 2, 'dec', 'qBittorrent/4.0.1', 'no', 'yes', '', 508),
...
(14, 'RTorrent 0.x(with libtorrent 0.x)', 'rTorrent 0.8.0 (with libtorrent 0.12.0)', '/^-lt([0-9A-E])([0-9A-E])([0-9A-E])([0-9A-E])-/', 4, 'hex', '-lt0C00-', '/^rtorrent\\/0\\.([0-9])\\.([0-9])\\/0\\.([1-9][0-9]*)\\.(0|[1-9][0-9]*)/', 4, 'dec', 'rtorrent/0.8.0/0.12.0', 'no', 'yes', '', 24),
(17, 'Transmission 2.0', 'Transmission 2.0.0', '/^-TR2([0-9])([0-9])([0-9])-/', 3, 'dec', '-TR2000-', '/^Transmission\\/2\\.([0-9])([0-9])/', 2, 'dec', 'Transmission/2.00', 'no', 'yes', '', 533),
(20, 'uTorrent 1.6.1', 'uTorrent 1.6.1', '/^-UT1610-/', 0, 'dec', '-UT1610-', '/^uTorrent\\/1610/', 0, 'dec', 'uTorrent/1610', 'no', 'no', '', 0),
(19, 'Transmission2.x', 'Transmission 2.0', '/^-TR2([0-9])([0-9])([0-9])-/', 3, 'dec', '-TR2000-', '/^Transmission\\/2\\.([0-9])([0-9])/', 3, 'dec', 'Transmission/2.00', 'no', 'yes', '', 4),
...
(22, 'uTorrent 1.8', 'uTorrent 1.8.5.0', '/^-UT18([5-9])([0-9])-/', 2, 'dec', '-UT1850-', '/^uTorrent\\/18([5-9])([0-9])/', 2, 'dec', 'uTorrent/1850', 'no', 'yes', '', 1),
...
(25, 'uTorrent 2.0', 'uTorrent 2.0.0.0', '/^-UT2([0-9])([0-9])([0-9])-/', 3, 'dec', '-UT2000-', '/^uTorrent\\/2([0-9])([0-9])([0-9])/', 3, 'dec', 'uTorrent/2000', 'no', 'yes', '', 215),
(27, 'uTorrent 3.0', 'uTorrent 3.0.0.0', '/^-UT3([0-9])([0-9])([0-9])-/', 3, 'dec', '-UT3000-', '/^uTorrent\\/3([0-9])([0-9])([0-9])/', 3, 'dec', 'uTorrent/3000', 'yes', 'yes', '', 12),
...
(30, 'uTorrent 3.4.3', 'uTorrent 3.4.3', '/^-UT3([0-9])([0-9])([0-9])-/', 3, 'dec', '-UT3430-', '/^uTorrent\\/3([0-9])([0-9])/', 2, 'dec', 'uTorrent/343', 'no', 'yes', '', 4),
(29, 'uTorrent 3.4.2', 'uTorrent 3.4.2', '/^-UT3([0-9])([0-9])([0-9])-/', 3, 'dec', '-UT3420-', '/^uTorrent\\/3([0-9])([0-9])/', 2, 'dec', 'uTorrent/342', 'no', 'yes', '', 1),
...
(32, 'uTorrent 3.5', 'uTorrent 3.5.0', '/^-UT35[0-9][0-9A-Za-z]-/', 2, 'dec', '-UT3500-', '/^uTorrent\\/35([0-9])/', 1, 'dec', 'uTorrent/350', 'no', 'yes', '', 92),
(33, 'uTorrent 3.x', 'uTorrent/3000', '/^-UT3([0-9])([0-9])([0-9])-/', 3, 'dec', '-UT3000-', '/^uTorrent\\/3([0-9])([0-9])([0-9])/', 3, 'dec', 'uTorrent/3000', 'no', 'yes', '', 0),
(34, 'uTorrentMac 1.0', 'uTorrentMac 1.0.0.0', '/^-UM1([0-9])([0-9])([0-9B])-/', 3, 'dec', '-UM1000-', '/^uTorrentMac\\/1([0-9])([0-9])([0-9B])/', 3, 'dec', 'uTorrentMac/1000', 'no', 'yes', '', 1),
...
(6, 'BitComet 1.56.3.13', 'BitComet 1.56.3.13', '/^-BC01([0-9])([0-9])-/', 2, 'dec', '-BC0156-', '/^BitComet\\/1\\.([0-9]+)\\.([0-9]+)\\.([0-9]+)/', 3, 'dec', 'BitComet/1.56.3.13', 'no', 'yes', '', 6),
(5, 'Azureus 5.0', 'Azureus 5.0.0.0', '/^-AZ5([0-9])([0-9])([0-9])-/', 3, 'dec', '-AZ5000-', '/^Azureus 5\\.([0-9])\\.([0-9])\\.([0-9])/', 3, 'dec', 'Azureus 5.0.0.0', 'no', 'yes', '', 18),
...
(37, 'Transmission 3.x', 'Transmission 3.0', '/^-TR3([0-9])([0-9])([0-9])-/', 3, 'dec', '-TR3000-', '/^Transmission\\/3\\.([0-9])([0-9])/', 2, 'dec', 'Transmission/3.00', 'no', 'yes', '', 162);
...
(1, '@126.com @163.com @qq.com @tom.com @yeah.net @sohu.com @sina.com @139.com @189.cn @wo.cn');
...
) ENGINE=MyISAM AUTO_INCREMENT=2774 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=2547578 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `bookmarks` (
  ...
  `userid` mediumint(8) unsigned NOT NULL DEFAULT '0'
) ENGINE=MyISAM AUTO_INCREMENT=140351 DEFAULT CHARSET=utf8;
...
(401, 4, 'c_movies', 'Movies/电影', 'catsprites.png', 0),
(402, 4, 'c_tvseries', 'TV Series/电视剧', 'catsprites.png', 3),
(403, 4, 'c_tvshows', 'TV Shows/综艺节目', 'catsprites.png', 4),
(404, 4, 'c_doc', 'Documentaries/纪录片', 'catsprites.png', 1),
(405, 4, 'c_anime', 'Animations/动漫', 'catsprites.png', 2),
(406, 4, 'c_mv', 'Music Videos/音乐MV', 'catsprites.png', 5),
(407, 4, 'c_sports', 'Sports/体育', 'catsprites.png', 6),
(408, 4, 'c_hqaudio', 'HQ Audio/高品质音频', 'catsprites.png', 8),
(409, 4, 'c_misc', 'Misc/其他', 'catsprites.png', 7),
(410, 4, '', 'Software/软件', 'appz.png', 11),
(411, 4, '', 'Games/游戏', 'games_pc.png', 10),
(600, 6, '', 'Limit/受限制', 'av/limit.png', 20),
(412, 4, '', 'Edu/教育', 'edu.png', 9),
(601, 6, '', '有码BD', 'av/cenbd.png', 21),
(604, 6, '', 'Portray/私模写真', 'av/ivpic.png', 24),
(605, 6, '', '步兵DVD', 'av/uendvd.png', 25),
(606, 6, '', '步兵HD', 'av/uenhd.png', 26),
(607, 6, '', '步兵Xvid', 'av/uensd.png', 27),
(602, 6, '', '有码HD', 'av/cenhd.png', 22),
(603, 6, '', '有码Xvid', 'av/censd.png', 23);
...
(6, 'Adult Mod', 'adult/', 'pic/category/adult/catsprites.css', 'yes', 'no', 'NexusPHP', 'Modified from SceneTorrents');
...
) ENGINE=MyISAM AUTO_INCREMENT=49847 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `complain_replies` (
  `id` int(10) unsigned NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=1828056 DEFAULT CHARSET=utf8;
...
(1, 0, '❦新手学习区❦', '入门初级选手', 0, 1, 0, 0, 1, 1),
(2, 1, '❅申诉、互助交流❅', '账号申诉、互助交流学习', 0, 0, 0, 0, 0, 1),
(3, 2, '☸邀请互助☸', '', 2, 2, 0, 0, 2, 1),
(4, 3, '♞播种训练营♞', '由于最近新手大量增加，特设立本版 本版供大家试种和修改种子的，欢迎来试种喵~~~ 发帖格式、出种不合格的帖子，将被移动到本版；待帖子合格后，可PM或@本版版主或超版、管理员移动到相应版面。10天未通过审核的将被删帖喵~ 注：版主们移动时请补加相应贡献喵~~', 1, 3, 0, 0, 12, 1),
(5, 0, '✥资源交流区✥', '楼上不是资源分享版块,不信你看楼上', 0, 1, 0, 0, 2, 1),
(6, 1, '♚影视讨论区♚', '', 1, 1, 0, 0, 1, 2),
(7, 2, '✡悬赏求种区✡', '防止求种资源帖过于分散，特设立此版 欢迎在本版发布悬赏喵~  风声紧了，大家发种都不容易，互相多多关照哦~   发帖时请选择“悬赏中”分类，并在标题中说清资源到底是什么   悬赏超过100可PM版主，申请设置高亮（请在帖中注明颜色，默认金色）   悬赏超过1000可设置加粗高亮 超过30天未解决将被自动视为过期悬赏   本版诚征版主两只', 1, 1, 0, 0, 2, 2),
(8, 0, '❂站务公告版块❂', '楼下说的是对的', 0, 3, 0, 0, 11, 3),
(9, 0, '☢种子举报☢', '不符合规范填写种子信息、违规、敏感资源欢迎在此反馈', 12, 3, 0, 0, 3, 1),
(24, 12, '☣垃圾回收版块☣', '以上楼说的都是对的，回收到这里的都是垃圾', 11, 11, 0, 0, 11, 3),
(25, 2, '✫建议意见版块✫', '楼上才是站务公告版块', 2, 2, 0, 0, 2, 3),
(26, 0, '盒子备案区', '盒子备案申诉专区', 1, 1, 0, 0, 1, 3);
...
) ENGINE=MyISAM AUTO_INCREMENT=10653 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=4295893 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `iplog_announce` (
  `userid` mediumint(8) unsigned NOT NULL,
...
(1, 'GXNAS导航', 'https://web.gxnas.com', '[WJQ]小窝'),
(2, '御宅说', 'https://www.otakusay.com', '[66哥]小窝'),
(4, '美寄词云', 'https://www.moage.cn', '美寄词云'),
(5, 'SM.MS图床', 'https://sm.ms/', 'SM.MS图床(推荐) '),
(6, ' 路过图床', 'https://imgchr.com/', ' 路过图床'),
(7, '影片信息获取', 'https://www.bfdz.ink/tools/ptgen', '种子信息获取工具'),
(8, '影片信息获取[推荐]  ', 'https://api.rhilip.info/ptgen.html', '种子信息获取工具[推荐]  '),
(9, 'ImageShack', 'http://imageshack.us/', 'ImageShack'),
(10, 'TheMovieDatabase (TMDb)', 'https://www.themoviedb.org/?language=zh-CN', 'TheMovieDB'),
(11, '七界传说', 'https://www.rosnas.com', '关注分享网络技术、硬件维护、游戏分享、新闻资讯！'),
(12, 'WebOS实验室', 'http://chdong.top/lab', 'WebOS实验室'),
(13, '末日動漫資源庫', 'https://share.acgnx.se', 'AcgnX Torrent Asia'),
(14, 'RARBG', 'http://rarbg.to/', 'RARBG Rarbg'),
(15, 'OshenPT', 'http://www.oshen.win/', 'OshenPT'),
(16, '电费计算器', 'https://dianfeijisuanqi.51240.com/', '便民查询网 - 免费查询工具大全 - 51240便民查询网'),
(17, 'CPU TOP', 'https://cpu.51240.com/', 'CPU性能排行'),
(18, 'Pt数据统计', 'http://1ptba.com/app/pt/', 'Pt站数据统计分析'),
(19, 'WysiBB', 'http://wysibb.com/demo/', 'BBcode editor'),
(20, 'Pt站导航', 'http://bt123.byethost15.com/ptbox/', 'Pt站导航'),
(21, '秒开4K高清电视直播', 'http://iptv.emby.icu', '秒开4K高清电视直播');
...
) ENGINE=MyISAM AUTO_INCREMENT=113619 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=11550 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=2037859 DEFAULT CHARSET=utf8;
...
(6, '统计资料', 'stats.php', '跟踪统计'),
(4, '广告管理', 'admanage.php', '在您的网站管理广告'),
(5, '上传者', 'uploaders.php', '上传者统计'),
(3, '所有客户端（目前）', 'allagents.php', '所有客户端（下载/上传/种子）'),
(2, '重复IP检查', 'ipcheck.php', '检查重复的IP用户'),
(1, '上传速度异常探测器', 'cheaters.php', '查看作弊者'),
(7, 'IP测试', 'testip.php', '测试，如果IP被禁止'),
(8, '积分', 'amountbonus.php', '添加一个或所有用户的积分'),
(9, '清除缓存', 'clearcache.php', '清除memcached的缓存');
...
(100, 1, '2020-01-14 23:12:38', '[quote= - 本站Tracker地址更新:][color=DarkGreen][b][size=4]爱读不读:\r\n本站特点：x264，x265，1080p，2160p，4K，UHD制作发布，精品高清，全站Free，2xFree，更新快，本站不保留影视资源。你有能力还是设置成rss下载。\r\n关于宣传。可以在或者百度贴吧宣传一下。网站程序邀请问题没有解决偶尔临时开放注册。\r\n目前资源全是自由发布，基本同步更新最新热门影视。另外没有兽站的可以试试在此常驻。\r\n\r\n[b]Tracker服务器的URL是:[/b]     https://1ptba.com/announce.php[/size][/b]\r\n连接不上服务器请更换如上地址。\r\n[color=Darkgreen][url=https://jq.qq.com/?_wv=1027&amp;k=5bRVvct]企鹅群号:939289463[/url][/color] 欢迎官方入群（虽然以新手团体居多 但都是有爱并且热情的老司机/姐， 以及永远无法脱团的一干壕）[/color]\r\n\r\n[quote= - 关于PT下载器]切勿使用迅雷等客户端下载本站资源。\r\nPC端专用下载器：[url=https://www.lanzous.com/i6hf0kd]uTorrent_2.0.4_绿完设置版[/url]\r\n群晖NAS系统请使用 [url=https://www.qbittorrent.org/download.php]qBittorrent[/url] 或 [url=https://transmissionbt.com/download/]Transmission 2.94[/url]\r\n如有疑问论坛/群组提出\r\n[/quote]\r\n[/quote]\r\n\r\n\r\n[quote]\r\n[quote=2021.1.23 - 数据迁移通知] [color=Red][b]祝贺，网站所有数据迁移完成！ \r\n[i]服务器近期进行代码更新，利于用户优化下载。[/i][/b][/color]\r\n[/quote]\r\n[quote=2020.2.3 - 开放/关闭 注册通知] [color=Red][b]全民行动抗击新型病毒肺炎，人人有责！\r\n[i]服务器2020.2.5- 2020.2.15开放注册。开启更多模式，利于用户更优下载。[/i][/b][/color]\r\n[/quote]\r\n[quote=2020.9.21 - 技术支持] 加入Transmission 3.x客户端支持的说明 https://1ptba.com/forums.php?action=viewtopic&amp;forumid=1&amp;topicid=25\r\n[/quote]\r\n[quote=2019.12.04 - 规则说明]种下载规则和带H&amp;R标记的种子说明 https://1ptba.com/forums.php?action=viewtopic&amp;topicid=4726\r\n[/quote]\r\n[quote=2019.12.02 - 网站迁徙完成]域名生效了，\r\nhttps://pt.1ptba.com 和https://1ptba.com/ 现在指向的都是同一个网站。\r\n网站域名迁徙tracker服务器中断连接几个小时。等大家重新开启做种，耐心等待 tracker服务器刷新，做种人数，会陆续恢复。红种的 重新开启做种就可以了。\r\n另外 这次网站搬家使用了新代码，修复魔力值问题，并且带有H&amp;R强制做种规则，这样大家下载会更快，避免死种坏种问题，请测试。\r\n[/quote]\r\n[/quote]', '网站公告', 'no');
...
) ENGINE=MyISAM AUTO_INCREMENT=5025 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=32632 DEFAULT CHARSET=utf8;
...
) ENGINE=MEMORY AUTO_INCREMENT=798544 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED;
...
) ENGINE=MyISAM AUTO_INCREMENT=12901 DEFAULT CHARSET=utf8;
...
(7, '2019-12-16 19:35:27', '亲爱的 1PTBar 会员们，你们更喜欢哪类资源？', '纯原盘(无损/无加工) ', 'DIY原盘(无损/带中字)', 'REMUX(保留主体/剔除无关音轨字幕)', '重编码(1080p&amp;720p/小体积) ', 'WEB-DL(网络流出影片/接近蓝光/小体积)', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
...
CREATE TABLE IF NOT EXISTS `posts` (
  ...
  `editedby` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `editdate` datetime NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=MyISAM AUTO_INCREMENT=23559 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=297200 DEFAULT CHARSET=utf8;
...
(2, 25, '下载规则 - <font class=striking>违规将会失去下载权限！</font>', '[*]过低的分享率会导致严重的后果，包括禁止帐号。详见[url=faq.php#22]常见问题[/url]。\r\n[*]种子促销规则：\r\n        [*]随机促销（种子上传后系统自动随机设为促销）：\r\n                [*]50%的概率成为“[color=#7c7ff6][b]50%下载[/b][/color]”；\r\n                [*]20%的概率成为“[color=#f0cc00][b]免费[/b][/color]”；\r\n                [*]25%的概率成为“[color=#aaaaaa][b]2x上传[/b][/color]”；\r\n                [*]25%的概率成为“[color=#7ad6ea][b]50%下载&2x上传[/b][/color]”；\r\n                [*]5%的概率成为“[color=#99cc66][b]免费&2x上传[/b][/color]”。\r\n        [*]文件总体积大于20GB的种子将自动成为“[color=#f0cc00][b]免费[/b][/color]”。\r\n        [*]Blu-ray Disk, HD DVD原盘将成为“[color=#f0cc00][b]免费[/b][/color]”。\r\n        [*]电视剧等每季的第一集将成为“[color=#f0cc00][b]免费[/b][/color]”。\r\n        [*]关注度高的种子将被设置为促销（由管理员定夺）。\r\n        [*]促销时限：\r\n                [*]除了“[color=#aaaaaa][b]2x上传[/b][/color]”以外，其余类型的促销限时7天（自种子发布时起）；\r\n                [*]“[color=#aaaaaa][b]2x上传[/b][/color]”无时限。\r\n        [*]所有种子在发布1个月后将自动永久成为“[color=#aaaaaa][b]2x上传[/b][/color]”。            \r\n        [*]我们也将不定期开启全站[color=#f0cc00][b]免费[/b][/color]，届时尽情狂欢吧~:mml:  :mml:  :mml:\r\n[*]你只能使用允许的BT客户端下载本站资源。详见[url=faq.php#29]常见问题[/url]。\r\n\r\n\r\n[size=5][b]下载规则 - [color=Red]下载带H&R标记的种子说明！[/color][/b][/size]\r\n[*][color=Orange][b](排长)Power User[/b][/color] 及以上用户可发布带有H&R的种子。\r\n[*][color=DarkOrange][b](贵宾)VIP[/b][/color] 及以上用户不受H&R限制。\r\n[*][color=DarkRed]有H&R的种子[b]22天内[/b]必须做种[b]168小时[/b]或者分享率达到[b]1.8[/b]。[/color]\r\n[*]累计得到[b]10个[/b]H&R时[color=Red][b]禁用账号[/b][/color]。\r\n[*]种子发布后30天不再参与H&R检查，取消前的记录继续检查。\r\n[*]可以花费[color=Red][b]10000个魔力值[/b][/color]消除一个H&R记录。'),
...
(4, 'chd', 1, 1, 1, 1, 1, 1, 1, 1, 10, 7),
(6, 'limit', 1, 1, 1, 1, 1, 1, 1, 1, 10, 7);
...
CREATE TABLE IF NOT EXISTS `shoutbox` (
  ...
  `ip` varchar(64) NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=7557 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=2386249 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=2093454 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=5129 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=1677484 DEFAULT CHARSET=utf8;
...
(8, '比特桶', 'bitbucketlog.php', '比特桶日志'),
(7, '登录失败', 'maxlogin.php', '显示失败的登录尝试'),
(6, '禁止IP', 'bans.php', '禁止/取消禁止IP'),
(5, '做清理', 'docleanup.php', '做清理功能'),
(4, '群发邮件', 'massmail.php', '发送电​​子邮件给所有用户'),
(3, 'MySQL的统计资料', 'mysql_stats.php', '查看MySQL统计'),
(2, '管理论坛', 'forummanage.php', '编辑/删除论坛'),
(1, '删除被禁用的用户', 'deletedisabled.php', '删除所有被禁用的用户'),
(9, '禁止EMAIL地址', 'bannedemails.php', '禁止电子邮件停止登记'),
(10, '允许电子邮件地址', 'allowedemails.php', '允许注册邮件'),
(11, '位置', 'location.php', '管理位置和定位速度'),
(12, '添加上传', 'amountupload.php', '添加上传到某些类'),
(13, '添加用户ID', 'adduser.php', '添加一个用户ID'),
(14, '搜索用户ID', 'usersearch.php', '用户搜索管理'),
(15, '被警告用户', 'warned.php', '被警告用户'),
(16, '投票', 'polloverview.php', '投票'),
(17, '推广链', 'promotionlink.php', '推广链'),
(18, '重置用户的密码', 'reset.php', '重置用户的密码'),
(19, '群聊区', 'shoutbox.php', '留言板'),
(20, '工作人员面板', 'staffpanel.php', '工作人员面板'),
(21, '激活的上传者', 'stats.php', '激活的上传者'),
(22, '管理组信箱', 'staffbox.php', '管理组信箱'),
(23, '给用户添加上载', 'amountupload.php', '添加上载到所有工作人员和用户。'),
(24, '添加友情链接', 'linksmanage.php', '添加友情链接'),
(25, '登录失败尝试', 'maxlogin.php', '登录失败尝试'),
(26, 'IP重复用户', 'ipcheck.php', 'IP重复用户'),
(27, '管理广告', 'admanage.php', '管理广告'),
(28, '所有客户端', 'allagents.php', ''),
(29, '允许的电邮地址列表', 'allowedemails.php', ''),
(30, '更新用户上载量', 'amountbonus.php', '');
...
CREATE TABLE IF NOT EXISTS `thanks` (
  ...
  `torrentid` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `userid` mediumint(8) unsigned NOT NULL DEFAULT '0'
) ENGINE=MyISAM AUTO_INCREMENT=1002044 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=33030 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `torrents_myrss` (
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `exam_uploaded` bigint(20) unsigned NOT NULL DEFAULT '0',
  `exam_downloaded` bigint(20) unsigned NOT NULL DEFAULT '0',
  `exam_seedbonus` decimal(10,1) unsigned NOT NULL DEFAULT '0.0',
  `exam_seedtime` bigint(20) unsigned NOT NULL DEFAULT '0',
  `exam_leechtime` bigint(20) NOT NULL DEFAULT '0',
  `exam_active` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=MyISAM AUTO_INCREMENT=88473 DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `users`
--

INSERT INTO `users` (`id`, `username`, `passhash`, `secret`, `email`, `status`, `added`, `last_login`, `last_access`, `last_home`, `last_offer`, `forum_access`, `last_staffmsg`, `last_pm`, `last_comment`, `last_post`, `last_browse`, `last_music`, `last_catchup`, `editsecret`, `privacy`, `stylesheet`, `caticon`, `fontsize`, `info`, `acceptpms`, `commentpm`, `ip`, `class`, `max_class_once`, `avatar`, `uploaded`, `downloaded`, `seedtime`, `leechtime`, `title`, `country`, `notifs`, `modcomment`, `enabled`, `avatars`, `donor`, `donated`, `donated_cny`, `donoruntil`, `warned`, `warneduntil`, `noad`, `noaduntil`, `torrentsperpage`, `topicsperpage`, `postsperpage`, `clicktopic`, `deletepms`, `savepms`, `showhot`, `showclassic`, `support`, `picker`, `stafffor`, `supportfor`, `pickfor`, `supportlang`, `passkey`, `promotion_link`, `uploadpos`, `forumpost`, `downloadpos`, `clientselect`, `signatures`, `signature`, `lang`, `cheat`, `download`, `upload`, `isp`, `invites`, `invited_by`, `gender`, `vip_added`, `vip_until`, `seedbonus`, `charity`, `bonuscomment`, `parked`, `leechwarn`, `leechwarnuntil`, `lastwarned`, `timeswarned`, `warnedby`, `sbnum`, `sbrefresh`, `hidehb`, `showimdb`, `showdescription`, `showcomment`, `showclienterror`, `showdlnotice`, `tooltip`, `shownfo`, `timetype`, `appendsticky`, `appendnew`, `appendpromotion`, `appendpicked`, `dlicon`, `bmicon`, `showsmalldescr`, `showcomnum`, `showlastcom`, `showlastpost`, `pmnum`, `school`, `showfb`, `exam_deadline`, `hr`, `exam_uploaded`, `exam_downloaded`, `exam_seedbonus`, `exam_seedtime`, `exam_leechtime`, `exam_active`) VALUES
(1, 'admin', '2aed22696e354369324003ef381e552a', 0x736b73716b676968787165696773766c676f7378, 'admin@cloudreve.org', 'confirmed', '2021-02-04 02:23:48', '2021-02-04 02:56:24', '2021-02-04 02:23:48', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, 0, 0x78666e716e6b6f6f6673786f6b6a6c66656f6a67, 'strong', 7, 1, 'medium', NULL, 'yes', 'yes', '', 30, 1, '', 10737418240, 0, 0, 0, '', 8, NULL, NULL, 'yes', 'yes', 'no', '0.00', '0.00', '0000-00-00 00:00:00', 'no', '0000-00-00 00:00:00', 'no', '0000-00-00 00:00:00', 0, 0, 0, 'firstpage', 'yes', 'no', 'yes', 'yes', 'no', 'no', '', '', '', '', 'a3d82d10150cfed530a595f638162a05', NULL, 'yes', 'yes', 'yes', 0, 'yes', '', 25, 0, 0, 0, 0, 3, 0, 'Male', 'no', '0000-00-00 00:00:00', '0.0', '0.0', NULL, 'no', 'no', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, 70, 120, 'no', 'yes', 'yes', 'yes', 'no', 1, 'off', 'yes', 'timealive', 'yes', 'yes', 'icon', 'yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no', 10, 35, 'yes', 0, 0, 0, 0, '0.0', 0, 0, 0);
...
) ENGINE=MyISAM AUTO_INCREMENT=121280 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `users`
  ...
  ADD KEY `users_exam_active_index` (`exam_active`);
...
--
ALTER TABLE `adclicks`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=38997;
--
...
--
ALTER TABLE `attendance`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2547578;
--
...
--
ALTER TABLE `bookmarks`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=140351;
--
-- AUTO_INCREMENT for table `categories`
--
ALTER TABLE `categories`
  MODIFY `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=608;
--
...
--
ALTER TABLE `comments`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=49847;
--
...
--
-- AUTO_INCREMENT for table `complain_replies`
--
ALTER TABLE `complain_replies`
...
--
ALTER TABLE `files`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1828056;
--
...
--
ALTER TABLE `friends`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2159;
--
-- AUTO_INCREMENT for table `fun`
--
ALTER TABLE `fun`
  MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=936;
--
...
--
ALTER TABLE `invites`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10653;
--
-- AUTO_INCREMENT for table `iplog`
--
ALTER TABLE `iplog`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4295893;
--
...
--
ALTER TABLE `loginattempts`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=113619;
--
-- AUTO_INCREMENT for table `magic`
--
ALTER TABLE `magic`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11550;
--
...
--
ALTER TABLE `messages`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2037859;
--
...
--
ALTER TABLE `offers`
  MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5025;
--
-- AUTO_INCREMENT for table `offervotes`
--
ALTER TABLE `offervotes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=32632;
--
...
--
ALTER TABLE `peers`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=798544;
--
...
--
ALTER TABLE `pollanswers`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12901;
--
...
--
ALTER TABLE `posts`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23559;
--
...
--
ALTER TABLE `readposts`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=297200;
--
-- AUTO_INCREMENT for table `regimages`
--
ALTER TABLE `regimages`
  MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=473;
--
...
--
ALTER TABLE `sitelog`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2386249;
--
-- AUTO_INCREMENT for table `snatched`
--
ALTER TABLE `snatched`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2093454;
--
...
--
ALTER TABLE `staffmessages`
  MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=445;
--
...
--
ALTER TABLE `subs`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5129;
--
-- AUTO_INCREMENT for table `suggest`
--
ALTER TABLE `suggest`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1677484;
--
...
--
ALTER TABLE `thanks`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1002044;
--
-- AUTO_INCREMENT for table `topics`
--
ALTER TABLE `topics`
  MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4842;
--
-- AUTO_INCREMENT for table `torrents`
--
ALTER TABLE `torrents`
  MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=33030;
--
...
--
ALTER TABLE `users`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=88473;
--
